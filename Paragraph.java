...
public class Paragraph 
{
	...
	/**
	 * Gets the current number of lines contained in the Paragraph
	 */
	public int size()
	{
		return lines.size();
	 ...
	 * @return the Line contained at the given index
	 */
	...
	/**
	 * Get the specific index of a given Line from the Paragraph 
	 * @param line the Line to get the index for
	 * @return the index of the Line in the Paragraph
	 */
